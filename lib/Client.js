...
const Event_1 = require("./Gamemodes/Event");
const InventoryManager_1 = require("./Items/InventoryManager");
const ItemUtils_1 = require("./Items/ItemUtils");
...
class Client {
    constructor(game, ws, ipAddress) {
        ...
        this.inventory = new InventoryManager_1.default(this);
        this.invisibilityEffect = 0;
        this.damageEffect = 0;
        this.healthEffect = 0;
        this.reloadEffect = 0;
        this.fovEffect = 0;
        this.invulnerabilityEffect = 0;
        this.spawnBase = null;
        this.absorptionEffect = 0;
        this.extraStatEffect = 0;
        this.accuracyEffect = 0;
        this.sacrificingEffect = 0;
        this.game = game;
        this.ws = ws;
        ...
        this.droneSpawner = new ItemUtils_1.DroneSpawner(this.game);
    }
    write() {
        ...
        switch (header) {
            ...
            case 9: {
                if (!Entity_1.Entity.exists(camera.cameraData.player))
                    return;
                if (this.game.arena instanceof Event_1.default) {
                    if (!camera.cameraData.player.relationsData?.team)
                        return;
            ...
            case 30:
                ...
                const isUse = r.u8();
                if (isUse === 0)
                    return this.inventory.dropItem(slot);
                if (isUse === 1)
                    return this.inventory.useItem(slot);
            default:
