...
class LivingEntity extends Object_1.default {
    ...
    static applyDamage(entity1, entity2) {
        ...
        if (dF1 !== 0) {
            ...
            if (entity2.cameraEntity && entity2 instanceof TankBody_1.default && entity2.cameraEntity instanceof Camera_1.default) {
                entity2.cameraEntity.client.absorptionEffect -= dF1;
                if (entity2.cameraEntity.client.absorptionEffect < 0) {
                    entity2.healthData.health += entity2.cameraEntity.client.absorptionEffect;
                    entity2.cameraEntity.client.absorptionEffect = 0;
                }
            }
            else
            ...
            if (entity2.config) {
                let attacker = entity1;
                while (attacker.relationsData.values.owner instanceof Object_1.default && attacker.relationsData.values.owner.hash !== 0)
                    attacker = attacker.relationsData.values.owner;
                if (attacker instanceof TankBody_1.default && attacker.cameraEntity instanceof Camera_1.default)
                    attacker.cameraEntity.cameraData.score += dF1;
            }
        }
        ...
        if (dF2 !== 0) {
            ...
            if (entity1.cameraEntity && entity1 instanceof TankBody_1.default && entity1.cameraEntity instanceof Camera_1.default) {
                entity1.cameraEntity.client.absorptionEffect -= dF2;
                if (entity1.cameraEntity.client.absorptionEffect < 0) {
                    entity1.healthData.health += entity1.cameraEntity.client.absorptionEffect;
                    entity1.cameraEntity.client.absorptionEffect = 0;
                }
            }
            else
            ...
            if (entity1.config) {
                let attacker = entity2;
                while (attacker.relationsData.values.owner instanceof Object_1.default && attacker.relationsData.values.owner.hash !== 0)
                    attacker = attacker.relationsData.values.owner;
                if (attacker instanceof TankBody_1.default && attacker.cameraEntity instanceof Camera_1.default)
                    attacker.cameraEntity.cameraData.score += dF2;
            }
        }
