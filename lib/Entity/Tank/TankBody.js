...
class TankBody extends Live_1.default {
    ...
    onKill(entity) {
        if (!(this.cameraEntity.cameraData.level >= 45 && entity instanceof AbstractShape_1.default)) {
    ...
    tick(tick) {
        ...
        if (this.cameraEntity instanceof Camera_1.default) {
            if (this.cameraEntity.client.invisibilityEffect) {
                --this.cameraEntity.client.invisibilityEffect;
                this.styleData.opacity -= 0.03;
            }
            else if (!this.definition.flags.invisibility) {
                this.styleData.opacity += 0.03;
            }
            if (this.cameraEntity.client.sacrificingEffect)
                --this.cameraEntity.client.sacrificingEffect;
        ...
        updateStats: {
            ...
            if (this.cameraEntity instanceof Camera_1.default && this.cameraEntity.client.damageEffect) {
            ...
            this.healthData.maxHealth *= 1 + (this.cameraEntity?.client?.healthEffect || 0);
        ...
        if (this.styleData.flags & 4) {
            if (this.cameraEntity instanceof Camera_1.default && this.cameraEntity.client.invulnerabilityEffect) {
                this.cameraEntity.client.invulnerabilityEffect--;
            }
            else if ((this.game.tick >= this.cameraEntity.cameraData.values.spawnTick + 374 || this.inputs.attemptingShot() || this.inputs.movement.magnitude > 0)) {
                this.styleData.flags ^= 4;
                this.damageReduction = 1.0;
            }
        }
        else if (this.cameraEntity instanceof Camera_1.default && this.cameraEntity.client.invulnerabilityEffect) {
            this.styleData.flags |= 4;
            this.damageReduction = 0.0;
        }
        this.accel.add({
