...
export default class EventArena extends ArenaEntity {
    ...
    public items: ItemManager = new ItemManager(this);

    public invincibilityTimeLeft = tps * 60 * 3;
    ...
    constructor(game: GameServer) {
        ...
        // elongated walls
        new MazeWall(game, -ARENA_SIZE / 2 + BASE_SIZE * 0.4375 - this.ARENA_PADDING, BASE_SIZE * 0.4375 - this.ARENA_PADDING * 1.375, ARENA_SIZE / 2, BASE_SIZE * 0.875 + this.ARENA_PADDING);
        new MazeWall(game, ARENA_SIZE / 2 - BASE_SIZE * 0.4375 + this.ARENA_PADDING, -BASE_SIZE * 0.4375 + this.ARENA_PADDING * 1.375, ARENA_SIZE / 2, BASE_SIZE * 0.875 + this.ARENA_PADDING);

        // spike walls
        new MazeWall(game, -ARENA_SIZE / 2 + BASE_SIZE * 1.375 - this.ARENA_PADDING / 2, 0, BASE_SIZE / 2.5, BASE_SIZE);
        new MazeWall(game, ARENA_SIZE / 2 - BASE_SIZE * 1.375 + this.ARENA_PADDING / 2, 0, BASE_SIZE / 2.5, BASE_SIZE);
