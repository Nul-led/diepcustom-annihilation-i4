...
export default class TankBody extends LivingEntity implements BarrelBase {
    ...
    public tick(tick: number) {
        ...
        if(this.definition.flags.invisibility) this.styleData.opacity -= this.definition.invisibilityRate;
        ...
        updateStats: {
            ...
            this.healthData.maxHealth *= 1 + ((this.cameraEntity as ClientCamera)?.client?.healthEffect || 0);
        ...
        if(this.styleData.flags & StyleFlags.isFlashing) {
            if(this.cameraEntity instanceof ClientCamera && this.cameraEntity.client.invulnerabilityEffect) {
        ...
        } else if(this.cameraEntity instanceof ClientCamera && this.cameraEntity.client.invulnerabilityEffect) {
            this.styleData.flags |= StyleFlags.isFlashing;
            this.damageReduction = 0.0;
        }
