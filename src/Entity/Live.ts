...
export default class LivingEntity extends ObjectEntity {
    ...
    protected static applyDamage(entity1: LivingEntity, entity2: LivingEntity) {
        ...
        if (dF1 !== 0) {
            ...
            if((entity2 as TankBody).cameraEntity && entity2 instanceof TankBody && entity2.cameraEntity instanceof ClientCamera) {
            ...
            } else entity2.healthData.health -= dF1;
        ...
        if (dF2 !== 0) {
            ...
            if((entity1 as TankBody).cameraEntity && entity1 instanceof TankBody && entity1.cameraEntity instanceof ClientCamera) {
            ...
            } else entity1.healthData.health -= dF2;
