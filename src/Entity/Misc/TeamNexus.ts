...
export default class Nexus extends LivingEntity {
    ...
    public constructor(game: GameServer, x: number, y: number, team: TeamEntity, config: NexusConfig, nexusBase: TeamBase, spawnBase: TeamBase) {
        super(game);
    ...
    public onDeath(killer: LivingEntity): void {
        ...
        this.spawnBase.styleData.color = Color.Neutral;
    ...
    public tick(tick: number) {
        ...
        for(const sacrifice of this.sacrifices) {
            ...
            this.healthData.health += (entity.healthData.maxHealth * entity.damagePerTick / (entity instanceof TankBody ? 20 : 8) * 0.01) * (sacrifice.sacrificingEffect ? 2 : 1);
